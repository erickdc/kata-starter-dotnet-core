...
namespace Kata.Spec
{
    ...
    public class when_adding_more_than_three_numbers
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_adding_more_than_one_negative
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        Because of = () => { _result = Catch.Exception( () => _systemUnderTest.Add("1, -2, -3")); };
        It should_return_an_error = () => { _result.Message.Should().Be("negatives not allowed: -2, -3"); };
        private static Calculator _systemUnderTest;
    ...
    public class when_input_has_numbers_greater_than_1000
    {
        ...
        It should_return_the_sum_less_than_1001 = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }

    public class when_adding_with_custom_multiple_delimeter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_input_has_multiple_single_custom_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
